...
sub AUTOLOAD {
    ...
    croak "&OpenGL::Glew::constant not defined" if $constname eq 'constant';
...
OpenGL::Glew - Perl extension for modern OpenGL
...
This file was mostly generated by parsing C<glew.h>. See
the OpenGL documentation at
L<https://www.opengl.org/sdk/docs/man4/>
